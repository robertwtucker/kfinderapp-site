...
export default function Page() {
  return (
    <div className="mx-20 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
      <section id="privacy_policy" className="mt-8">
      ...
      <section id="interpretation_and_definitions" className="mt-8">
        ...
        <ul className="mx-10 list-disc">
          ...
          <li>
            <p>
              <strong>Application</strong> refers to KFinder, the software program provided by the
              Company.
            </p>
          </li>
          <li>
            <p>
              <strong>Business</strong>, for the purpose of CCPA/CPRA, refers to the Company as the
              legal entity that collects Consumers&apos; personal information and determines the
          ...
          <li>
            <p>
              <strong>CCPA</strong> and/or <strong>CPRA</strong> refers to the California Consumer
              Privacy Act (the &quot;CCPA&quot;) as amended by the California Privacy Rights Act of
              2020 (the &quot;CPRA&quot;).
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Consumer</strong>, for the purpose of the CCPA/CPRA, means a natural person
              who is a California resident. A resident, as defined in the law, includes (1) every
              individual who is in the USA for other than a temporary or transitory purpose, and (2)
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Kentucky, United States
            </p>
          </li>
          <li>
            <p>
      ...
      <section id="collecting_and_using_your_personal_data" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
          Collecting and Using Your Personal Data
        </h2>
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Types of Data Collected</h3>
        <h4 className="my-2 text-lg font-bold tracking-tighter sm:text-xl">Personal Data</h4>
        <p>
        ...
        <h4 className="my-2 text-xl font-bold tracking-tighter sm:text-xl">Usage Data</h4>
        ...
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Use of Your Personal Data</h3>
        ...
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">
        ...
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Delete Your Personal Data</h3>
        <p>
        ...
        <h4 className="my-2 text-lg tracking-tighter sm:text-xl">Business Transactions</h4>
        <p>
        ...
        <h4 className="my-2 text-lg tracking-tighter sm:text-xl">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose Your Personal Data if
          required to do so by law or in response to valid requests by public authorities (e.g. a
          court or a government agency).
        </p>
        <h4 className="my-2 text-lg tracking-tighter sm:text-xl">Other legal requirements</h4>
        <p>
      ...
      <section id="gdpr_privacy" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">GDPR Privacy</h2>
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">
        ...
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Your Rights under the GDPR</h3>
        <p>
      ...
      <section id="ccpa_cpra_privacy_notice" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
        ...
        <p>
          ...
          of Our knowledge that some of that information from the applicable category may be and may
        ...
        <ul className="mx-10 list-disc">
          ...
          <li>
            <strong>From Service Providers</strong>. For example, or other third-party vendors that
            We use to provide the Service to You.
          </li>
        </ul>
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Use of Personal Information</h3>
        <p>
        ...
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Share of Personal Information</h3>
        <p>
        ...
        <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Sale of Personal Information</h3>
        <p>
        ...
        <ul className="mx-10 list-disc">
          ...
          <li>
            ...
            request that We disclose information to You about Our collection, use, sale, disclosure
            for business purposes and share of personal information. Once We receive and confirm
          ...
          <li>
            ...
            opt-out request, please see the &quot;Do Not Sell My Personal Information&quot; section
            or contact Us.
          </li>
          <li>
            <strong>The right to correct Personal Data.</strong> You have the right to correct or
            rectify any inaccurate personal information about You that We collected. Once We receive
            and confirm Your request, We will use commercially reasonable efforts to correct (and
            direct our Service Providers to correct) Your personal information, unless an exception
            applies.
          </li>
          <li>
            <strong>The right to limit use and disclosure of sensitive Personal Data.</strong> You
            have the right to request to limit the use or disclosure of certain sensitive personal
            information We collected about You, unless an exception applies. To submit, please see
            the &quot;Limit the Use or Disclosure of My Sensitive Personal Information&quot; section
            or contact Us.
          </li>
          <li>
        ...
        <p>
          ...
          Use or Disclosure of My Sensitive Personal Information&quot; section for more information
          on how to opt out and limit the use of sensitive information collected.
        </p>
        <p>
          Additionally, in order to exercise any of Your rights under the CCPA/CPRA, and if You are
          a California resident, You can contact Us by visiting this page on our website:{' '}
        ...
        <p>
          ...
          be extended once by an additional 45 days when reasonably necessary and with prior notice.
        </p>
        <p>
      ...
      <section id="do_not_track_policy_as_required_by_ccaloppa" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
      ...
      <section id="your_california_privacy_rights" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
      ...
      <section id="california_privacy_rights_for_minor_users" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
      ...
      <section id="childrens_privacy" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
          Children&apos;s Privacy
        </h2>
        <p>
      ...
      <section id="links_to_other_websites" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
      ...
      <section id="changes_to_this_privacy_policy" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">
      ...
      <section id="contact_us" className="mt-8">
        <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, You can contact us by visiting this
          page on our website:{' '}
          <Link className="underline-offset-4 hover:underline" href="/contact">
            https://kfinderapp.com/contact
          </Link>
