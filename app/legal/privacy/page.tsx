  ...
  return (
    <div className="mx-20 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
      ...
      <section id="collecting_and_using_your_personal_data" className="mt-8">
        ...
        <p>
          While using Our Service, We will not ask You to provide Us with any personally
      ...
      <section id="childrens_privacy" className="mt-8">
        ...
        <p>
          ...
          age of 13 without verification of parental consent, We will take steps to remove that
      ...
      <section id="changes_to_this_privacy_policy" className="mt-8">
        ...
        <p>
          We will let You know via notice on Our Service, prior to the change becoming effective and
      ...
      <section id="contact_us" className="mt-8">
        ...
        <p>
          If you have any questions about this Privacy Policy, You can contact Us by emailing:
