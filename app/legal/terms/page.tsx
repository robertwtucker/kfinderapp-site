...
export default function Page() {
  return (
    <div className="mx-20 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
      ...
      <ul className="mx-10 list-disc">
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to KFinder.
          </p>
        </li>
        <li>
          <p>
      ...
      <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">Acknowledgment</h2>
      <p>
      ...
      <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">Termination</h2>
      <p>
      ...
      <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">Governing Law</h2>
      <p>
      ...
      <h2 className="my-4 text-xl font-bold tracking-tighter sm:text-3xl">Disputes Resolution</h2>
      <p>
      ...
      <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Severability</h3>
      <p>
      ...
      <h3 className="my-3 text-xl tracking-tighter sm:text-2xl">Waiver</h3>
      <p>
